  ...
  public static class ApplicationDbContextFactory
  {
    ...
    public static void SeedSampleData(ApplicationDbContext context)
    {
      ...
      context.Refills.AddRange(
        ...
        new Domain.Entities.Refill { Id = 7, CouponId = 6, Type = FuelType.GASOLINE, StartAmount = 10.5, EndAmount = 15.5, TankState = TankState.PARTIALLY_FILLED, Date = new DateTime(2020, 12, 17), LocationId = 4 }
      );
