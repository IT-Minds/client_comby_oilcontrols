...
import { genLocationClient, genStatsClient } from "services/backend/apiClients";
...
const ConsumptionTableComp: FC<Props> = ({
  preLoadedData = [],
  preloadDataNeedle = "",
  ...
  //       genStatsClient().then(client =>
  //         client.getUsageHistory(locationId, new Date(needle), size, skip)
  //       ),
  //     dataDispatch,
  //     {
